package com.hamiddev.todolist.ui.datePicker.view;
...
import com.hamiddev.todolist.ui.datePicker.util.PersianCalendarConstants;
import com.hamiddev.todolist.ui.datePicker.util.PersianCalendarUtils;
import com.hamiddev.todolist.ui.datePicker.util.PersianHelper;
...
public class PersianDatePicker extends LinearLayout {
    ...
    private void updateVariablesFromXml(Context context, AttributeSet attrs) {
         ...
         */
//        showDay = a.getBoolean(R.styleable.PersianDatePicker_showDay,true);
    ...
    public void mustShowDay(boolean showDay){
    ...
    private void updateViewData() {
        ...
        if (showDay!=null){
            if (showDay)
                dayNumberPicker.setVisibility(VISIBLE);
            else
                dayNumberPicker.setVisibility(GONE);
        }
